...
hospitals = [
    # ==========================================
    # 1. HYDERABAD & TELANGANA (PIN 500xxx)
    # ==========================================
    {
        "id": 1,
        ...
        "specialties": ["cardiology", "icu", "cath_lab", "emergency", "radiology", "oncology", "orthopedics", "diagnostics", "dialysis", "maternity"],
        ...
        "beds": [
            {"category": "GENERAL", "total_beds": 120, "occupied_beds": 98, "available_beds": 22, "data_status": "SIMULATED"},
            {"category": "SEMI_PRIVATE", "total_beds": 45, "occupied_beds": 37, "available_beds": 8, "data_status": "SIMULATED"},
            {"category": "PRIVATE", "total_beds": 35, "occupied_beds": 30, "available_beds": 5, "data_status": "SIMULATED"},
            {"category": "ICU", "total_beds": 25, "occupied_beds": 20, "available_beds": 5, "data_status": "SIMULATED"}
        ]
    },
    {
        "id": 2,
        ...
        "beds": [
            {"category": "GENERAL", "total_beds": 80, "occupied_beds": 68, "available_beds": 12, "data_status": "SIMULATED"},
    ...
    },
    {
        ...
        "emergency_available": True,
        "nabh_accredited": True,
        "specialties": ["cardiology", "icu", "cath_lab", "emergency", "radiology", "dialysis", "oncology", "orthopedics", "diagnostics"],
    ...
    },
    {
        ...
        "beds": [
            {"category": "GENERAL", "total_beds": 100, "occupied_beds": 84, "available_beds": 16, "data_status": "SIMULATED"},
            {"category": "SEMI_PRIVATE", "total_beds": 40, "occupied_beds": 33, "available_beds": 7, "data_status": "SIMULATED"},
    ...
    },
    {
        ...
        "emergency_available": True,
        "nabh_accredited": True,
        "specialties": ["cardiology", "icu", "cath_lab", "emergency", "radiology", "oncology", "orthopedics", "dialysis"],
        "empaneled_payers": ["STAR_HEALTH", "HDFC_ERGO", "ICICI_LOMBARD", "CARE_HEALTH", "CGHS", "AAROGYASRI"],
        "markup_multiplier": 1.2,
        "rooms": [
            {"category": "GENERAL", "name": "General Ward Bed", "daily_tariff": 1800.0, "status": "COMPATIBLE", "description": "Multi-occupancy ward", "data_status": "AUTHORITATIVE"},
            {"category": "SEMI_PRIVATE", "name": "Semi-Private Room", "daily_tariff": 4100.0, "status": "COMPATIBLE", "description": "Twin sharing room", "data_status": "AUTHORITATIVE"},
            {"category": "PRIVATE", "name": "Single Private A/C Room", "daily_tariff": 7600.0, "status": "EXCEEDS_CAP", "description": "Private room", "data_status": "AUTHORITATIVE"},
            {"category": "ICU", "name": "Intensive Care Unit (ICU)", "daily_tariff": 11200.0, "status": "VERIFY", "description": "Critical care ICU", "data_status": "AUTHORITATIVE"}
        ],
        "beds": [
            {"category": "GENERAL", "total_beds": 250, "occupied_beds": 218, "available_beds": 32, "data_status": "SIMULATED"},
            {"category": "SEMI_PRIVATE", "total_beds": 80, "occupied_beds": 69, "available_beds": 11, "data_status": "SIMULATED"},
            {"category": "PRIVATE", "total_beds": 60, "occupied_beds": 52, "available_beds": 8, "data_status": "SIMULATED"},
    ...
    },
    {
        ...
        "email": "contactus@continentalhospitals.com",
        "total_beds": 750,
        "icu_beds": 110,
        "emergency_available": True,
        "nabh_accredited": True,
        "specialties": ["cardiology", "icu", "cath_lab", "emergency", "radiology", "oncology", "orthopedics", "diagnostics"],
        "empaneled_payers": ["STAR_HEALTH", "HDFC_ERGO", "CARE_HEALTH", "ICICI_LOMBARD", "CGHS"],
        ...
        "rooms": [
            ...
            {"category": "ICU", "name": "Intensive Care Unit (ICU)", "daily_tariff": 12500.0, "status": "VERIFY", "description": "Critical care ICU", "data_status": "AUTHORITATIVE"}
        ],
        "beds": [
            {"category": "GENERAL", "total_beds": 150, "occupied_beds": 126, "available_beds": 24, "data_status": "SIMULATED"},
            {"category": "SEMI_PRIVATE", "total_beds": 50, "occupied_beds": 42, "available_beds": 8, "data_status": "SIMULATED"},
            {"category": "PRIVATE", "total_beds": 40, "occupied_beds": 35, "available_beds": 5, "data_status": "SIMULATED"},
            {"category": "ICU", "total_beds": 30, "occupied_beds": 25, "available_beds": 5, "data_status": "SIMULATED"}
        ]
    },
    {
        "id": 7,
        "name": "AIG Hospitals (Asian Institute of Gastroenterology), Gachibowli",
        "hfr_id": "IN3610000207",
        "facility_type": "PRIVATE_SUPERSPECIALTY",
        "ownership": "PRIVATE_FOR_PROFIT",
        "address": "1-66/AIG/1 to 5, Mindspace Road, Gachibowli",
        "city": "Hyderabad",
        "district": "Rangareddy",
        "state": "Telangana",
        "pincode": "500032",
        ...
        "emergency_available": True,
        "nabh_accredited": True,
        "specialties": ["cardiology", "icu", "cath_lab", "emergency", "radiology", "oncology", "diagnostics", "dialysis"],
        "empaneled_payers": ["STAR_HEALTH", "HDFC_ERGO", "ICICI_LOMBARD", "CARE_HEALTH", "CGHS", "AAROGYASRI"],
        "markup_multiplier": 1.25,
        "rooms": [
        ...
        "beds": [
            {"category": "GENERAL", "total_beds": 180, "occupied_beds": 154, "available_beds": 26, "data_status": "SIMULATED"},
            {"category": "SEMI_PRIVATE", "total_beds": 60, "occupied_beds": 51, "available_beds": 9, "data_status": "SIMULATED"},
            {"category": "PRIVATE", "total_beds": 45, "occupied_beds": 39, "available_beds": 6, "data_status": "SIMULATED"},
            {"category": "ICU", "total_beds": 35, "occupied_beds": 30, "available_beds": 5, "data_status": "SIMULATED"}
        ]
    },

    # ==========================================
    # 2. BENGALURU & KARNATAKA (PIN 560xxx)
    # ==========================================
    {
        "id": 8,
    ...
    },
    {
        ...
        "nabh_accredited": True,
        "specialties": ["cardiology", "icu", "cath_lab", "emergency", "radiology", "oncology", "orthopedics", "dialysis"],
        "empaneled_payers": ["STAR_HEALTH", "HDFC_ERGO", "ICICI_LOMBARD", "CARE_HEALTH", "PM_JAY", "CGHS"],
        "markup_multiplier": 1.1,
        "rooms": [
            {"category": "GENERAL", "name": "General Ward Bed", "daily_tariff": 1600.0, "status": "COMPATIBLE", "description": "Multi-occupancy ward", "data_status": "AUTHORITATIVE"},
            {"category": "SEMI_PRIVATE", "name": "Semi-Private Room", "daily_tariff": 3800.0, "status": "COMPATIBLE", "description": "Twin sharing room", "data_status": "AUTHORITATIVE"},
            {"category": "PRIVATE", "name": "Single Private Room", "daily_tariff": 6800.0, "status": "EXCEEDS_CAP", "description": "Private room", "data_status": "AUTHORITATIVE"},
            {"category": "ICU", "name": "Intensive Care Unit (ICU)", "daily_tariff": 10000.0, "status": "VERIFY", "description": "Critical care ICU", "data_status": "AUTHORITATIVE"}
        ],
        "beds": [
            {"category": "GENERAL", "total_beds": 350, "occupied_beds": 305, "available_beds": 45, "data_status": "SIMULATED"},
            {"category": "SEMI_PRIVATE", "total_beds": 120, "occupied_beds": 98, "available_beds": 22, "data_status": "SIMULATED"},
            {"category": "PRIVATE", "total_beds": 80, "occupied_beds": 69, "available_beds": 11, "data_status": "SIMULATED"},
            {"category": "ICU", "total_beds": 70, "occupied_beds": 60, "available_beds": 10, "data_status": "SIMULATED"}
        ]
    },

    # ==========================================
    # 3. MUMBAI & MAHARASHTRA (PIN 400xxx)
    # ==========================================
    {
        "id": 12,
    ...
    },
    {
        ...
        "nabh_accredited": True,
        "specialties": ["cardiology", "icu", "cath_lab", "emergency", "radiology", "oncology", "orthopedics", "dialysis"],
        "empaneled_payers": ["STAR_HEALTH", "HDFC_ERGO", "ICICI_LOMBARD", "CARE_HEALTH"],
        "markup_multiplier": 1.4,
        "rooms": [
            {"category": "GENERAL", "name": "General Ward Bed", "daily_tariff": 2600.0, "status": "COMPATIBLE", "description": "Multi-occupancy ward", "data_status": "AUTHORITATIVE"},
            {"category": "SEMI_PRIVATE", "name": "Semi-Private Room", "daily_tariff": 5200.0, "status": "EXCEEDS_CAP", "description": "Twin sharing room", "data_status": "AUTHORITATIVE"},
            {"category": "PRIVATE", "name": "Single Private A/C Room", "daily_tariff": 9800.0, "status": "EXCEEDS_CAP", "description": "Private room", "data_status": "AUTHORITATIVE"},
            {"category": "ICU", "name": "Intensive Care Unit (ICU)", "daily_tariff": 14500.0, "status": "VERIFY", "description": "Critical care ICU", "data_status": "AUTHORITATIVE"}
        ],
        "beds": [
            {"category": "GENERAL", "total_beds": 140, "occupied_beds": 118, "available_beds": 22, "data_status": "SIMULATED"},
            {"category": "SEMI_PRIVATE", "total_beds": 50, "occupied_beds": 43, "available_beds": 7, "data_status": "SIMULATED"},
            {"category": "PRIVATE", "total_beds": 40, "occupied_beds": 35, "available_beds": 5, "data_status": "SIMULATED"},
            {"category": "ICU", "total_beds": 30, "occupied_beds": 26, "available_beds": 4, "data_status": "SIMULATED"}
        ]
    },

    # ==========================================
    # 4. DELHI & NCR (PIN 110xxx)
    # ==========================================
    {
        "id": 14,
    ...
    },
    {
        ...
        "emergency_available": True,
        "nabh_accredited": True,
        "specialties": ["cardiology", "icu", "cath_lab", "emergency", "radiology", "oncology", "orthopedics", "dialysis", "maternity"],
        "empaneled_payers": ["STAR_HEALTH", "HDFC_ERGO", "PM_JAY", "CGHS"],
        "markup_multiplier": 1.0,
        "rooms": [
            {"category": "GENERAL", "name": "General Ward Bed", "daily_tariff": 1000.0, "status": "COMPATIBLE", "description": "Subsidized central government ward", "data_status": "AUTHORITATIVE"},
            {"category": "SEMI_PRIVATE", "name": "Semi-Private Room", "daily_tariff": 2200.0, "status": "COMPATIBLE", "description": "Twin sharing room", "data_status": "AUTHORITATIVE"},
            {"category": "PRIVATE", "name": "Single Private Room", "daily_tariff": 4000.0, "status": "COMPATIBLE", "description": "Special room", "data_status": "AUTHORITATIVE"},
            {"category": "ICU", "name": "Intensive Care Unit (ICU)", "daily_tariff": 6500.0, "status": "VERIFY", "description": "Critical care ICU", "data_status": "AUTHORITATIVE"}
        ],
        "beds": [
            {"category": "GENERAL", "total_beds": 600, "occupied_beds": 560, "available_beds": 40, "data_status": "SIMULATED"},
            {"category": "SEMI_PRIVATE", "total_beds": 150, "occupied_beds": 132, "available_beds": 18, "data_status": "SIMULATED"},
            {"category": "PRIVATE", "total_beds": 80, "occupied_beds": 72, "available_beds": 8, "data_status": "SIMULATED"},
            {"category": "ICU", "total_beds": 90, "occupied_beds": 81, "available_beds": 9, "data_status": "SIMULATED"}
        ]
    },

    # ==========================================
    # 5. CHENNAI & TAMIL NADU (PIN 600xxx)
    # ==========================================
    {
        "id": 16,
        ...
        "rooms": [
            ...
            {"category": "SEMI_PRIVATE", "name": "Semi-Private Room", "daily_tariff": 4200.0, "status": "COMPATIBLE", "description": "Twin sharing room", "data_status": "AUTHORITATIVE"},
            {"category": "PRIVATE", "name": "Single Private A/C Room", "daily_tariff": 7800.0, "status": "EXCEEDS_CAP", "description": "Private room", "data_status": "AUTHORITATIVE"},
            {"category": "ICU", "name": "Intensive Care Unit (ICU)", "daily_tariff": 11800.0, "status": "VERIFY", "description": "Critical care ICU", "data_status": "AUTHORITATIVE"}
        ],
        "beds": [
            {"category": "GENERAL", "total_beds": 120, "occupied_beds": 99, "available_beds": 21, "data_status": "SIMULATED"},
            {"category": "SEMI_PRIVATE", "total_beds": 45, "occupied_beds": 38, "available_beds": 7, "data_status": "SIMULATED"},
            {"category": "PRIVATE", "total_beds": 35, "occupied_beds": 31, "available_beds": 4, "data_status": "SIMULATED"},
            {"category": "ICU", "total_beds": 25, "occupied_beds": 21, "available_beds": 4, "data_status": "SIMULATED"}
        ]
    }
]
...
print(f"Successfully generated {len(hospitals)} multi-metro hospitals across Hyderabad, Bengaluru, Mumbai, Delhi, and Chennai to {out_path}")
