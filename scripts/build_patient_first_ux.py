...
import { 
  ...
  ChevronUp, ShieldAlert, Clock, Zap, ChevronRight, X, ExternalLink
} from "lucide-react"
...
export default function PatientFirstHospitality() {
  ...
  const calculateFinancials = (room: RoomOption) => {
    const days = 4
    const baseProcedureBill = 80000 // Base Angioplasty package
  ...
  const [chatMessages, setChatMessages] = useState<Array<{ role: string; content: string; citations?: any[] }>>([
    {
      role: "assistant",
      content: `Hello Ananya! I am ASK HOSPITALITY. I am actively tracking your Star Health policy (₹5,00,000 SI), your requested care (${selectedFacilities.map(f => f.toUpperCase()).join(" + ")}), and ${selectedHospital.name}. How can I assist your admission decision today?`
    }
  ])
            ...
            <div className="bg-[#0F1B38]/90 border border-slate-700/60 rounded-3xl p-8 shadow-2xl backdrop-blur-xl space-y-6">
              ...
              <div className="border-b border-slate-700/60 pb-5">
                <span className="text-[11px] font-bold uppercase tracking-widest text-teal-400 flex items-center gap-1.5 mb-3">
                  <User className="w-3.5 h-3.5" /> Patient Identity
                </span>
        ...
        <div className="min-h-screen p-6 sm:p-10 max-w-5xl mx-auto space-y-8 animate-fadeIn">
          ...
          <div className="space-y-2">
            ...
            <p className="text-slate-400 text-sm sm:text-base max-w-2xl">
              Select the facilities or services you need. We'll find hospitals that can provide them while considering your policy constraints.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-slate-800 pb-6">
            <div>
              ...
              <p className="text-slate-400 text-sm mt-1">
                Based on {patientName}'s policy and selected needs (<strong className="text-teal-300">{selectedFacilities.map(f => f.toUpperCase()).join(" + ")}</strong>).
              </p>
            </div>
          ...
          <main className="flex-1 ml-72 p-8 max-w-6xl mx-auto space-y-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
                ...
                <div className="bg-[#0F1B38]/90 border border-emerald-500/30 rounded-3xl p-6 shadow-xl space-y-3">
                  ...
                  <div className="space-y-2 text-slate-200">
                    ...
                    <div className="p-2.5 bg-emerald-950/40 rounded-xl border border-emerald-500/20">
                      ✓ <strong>Hospital Geocodes:</strong> Verified via data.gov.in
                    </div>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <p className="text-slate-300 mt-2 leading-relaxed">
                      {financials.isRoomCapped
                        ...
                        : "Your room and policy are optimal! Proceed to verify cashless pre-authorization at Apollo Hospitals."}
                    </p>
                  </div>
            ...
            <section id="ai-assistant" className="scroll-mt-8 space-y-6">
              <div className="border-b border-slate-800 pb-4">
                ...
                <p className="text-slate-400 text-sm mt-1">
                  Context-aware assistant pre-grounded in {patientName}'s policy, {selectedHospital.name}, and selected {currentRoom.label}.
                </p>
              </div>
              ...
              {hospitalList.map(h => (
                ...
                >
                  <div>
                    ...
                    <div className="text-emerald-400 text-[11px] font-semibold mt-1">✓ {h.match_status}</div>
                  </div>
                  <div className="text-right">
